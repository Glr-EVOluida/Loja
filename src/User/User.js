    ...
    render() {
        ...
        return (
            <div className='container-fluid' style={{ marginTop: 20 }}>
                ...
                <div className='row'>
                    <div className='col-md-3 col-xs-12' style={{ margin: 0, padding: 0 }} >
                        <div className="select-main">
                            <label className="select-image" htmlFor="file" onClick={() => { if (!this.state.disabled === false) { alert('Ative o modo de edição para alterar a imagem') } }}>
                                <i className="fas fa-camera"></i> Carregar foto do Perfil
                                </label>
                            <div className="imagePreview" > {view} </div>
                        </div>
                    </div>
                    ...
                    <div className='col-md-9'>
                        <form>
                            ...
                            <div className='col-md-5' style={{ marginTop: 10 }}>
                                <label>Cep</label>
                                <input type='text' className='form-control' value={this.state.cep} onChange={(e) => {
                                ...
                                }} disabled={this.state.disabled} maxLength={9} />
                            </div>
                            <div className='col-md-6' style={{ marginTop: 10 }}>
                                ...
                                <input type='text' className='form-control' value={this.state.telefone} onChange={(e) => {
                                    ...
                                    this.setState({ telefone: word })
                                }} maxLength={16} disabled={this.state.disabled} />
                            </div>
